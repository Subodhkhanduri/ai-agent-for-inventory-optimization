...
def calculate_batch_periodic_review(df: pd.DataFrame, review_period_days: int = 7) -> pd.DataFrame:
    ...
    return results_df
d e f   c a l c u l a t e _ e o q ( a n n u a l _ d e m a n d :   f l o a t ,   o r d e r i n g _ c o s t :   f l o a t ,   h o l d i n g _ c o s t _ p e r _ u n i t :   f l o a t )   - >   f l o a t :   r e t u r n   m a t h . s q r t ( ( 2   *   a n n u a l _ d e m a n d   *   o r d e r i n g _ c o s t )   /   h o l d i n g _ c o s t _ p e r _ u n i t )  
 